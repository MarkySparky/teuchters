...
<span class="cstat-no" title="statement not covered" >      shouldCompileTo(string, {person: {first: "Alan", last: "Markson"}}, "Alan Markson");</span>
    });
    it("with with function argument", <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >      var string = "{{#with person}}{{first}} {{last}}{{/with}}";</span>
<span class="cstat-no" title="statement not covered" >      shouldCompileTo(string, {person: <span class="fstat-no" title="function not covered" >function() {</span> <span class="cstat-no" title="statement not covered" >return {first: "Alan", last: "Markson"};}</span>}, "Alan Markson");</span>
    });
