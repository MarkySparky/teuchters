...
<span class="cstat-no" title="statement not covered" >    var context = [</span>
      { name: "Mark Doe", location: { city: "Chicago" } },
...
<span class="cstat-no" title="statement not covered" >    equals(result, "Mark DoeJane DoeMark DoeJane DoeMark DoeJane Doe", 'It should output multiple times');</span>
  });
&nbsp;
