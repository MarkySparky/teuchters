...
```js
var users = [
    {name:'Mark', surname:'connor', beard:false},
    {name:'Mark', surname:'doe', beard:true},
    {name:'jane', surname:'doe', beard:false}
];
// filter item that matches all properties/values pairs
filter(arr, {name:'Mark', beard:false});
// > [{name:'Mark', surnname:'connor', beard:false}]
// items where 'beard' is a truthy value
filter(arr, 'beard');
// > [{name:'Mark', surnname:'doe', beard:true}]
```
...
find(arr, {name:'Mark'}); // {name:'Mark', surnname:'connor', beard:false}
// first item where 'beard' is a truthy value
find(arr, 'beard'); // {name:'Mark', surnname:'doe', beard:true}
```
...
findLast(arr, {name:'Mark'}); // {name:'Mark', surnname:'doe', beard:true}
// last item where 'beard' is a truthy value
findLast(arr, 'beard'); // {name:'Mark', surnname:'doe', beard:true}
```
...
```js
var users = [{name : 'Mark', age: 21}, {name: 'Jane', age : 27}];
var names = pluck(users, 'name'); // ["Mark", "Jane"]
...
var users = [{name: 'Mark'}, {name: 'paul'}, {name: 'Mark'}];
